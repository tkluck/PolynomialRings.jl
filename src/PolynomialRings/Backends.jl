...
module Gröbner
    ...
    """
    gröbner_transformation(G::AbstractVector, args...) = gröbner_transformation(cur_default, G, args...)
    """
    ...
    """
    gröbner_basis(G::AbstractVector, args...) = gröbner_basis(cur_default, G, args...)
end
