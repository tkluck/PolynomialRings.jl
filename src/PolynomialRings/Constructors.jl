...
free_generators(::Type{Val{N}}) where N = generators(Polynomial{Vector{Term{TupleMonomial{N,Int}, Int}}, :degrevlex})

free_generators(::Type{Val{Inf}}) = generators(Polynomial{Vector{Term{VectorMonomial{SparseVector{Int,Int}}, Int}}, :deglex})
